...
* Dark regions (provided as Blacklist_hg19.xlsx in Basic_info folder for hg19, or could be downloaded from UCSC table browser)
* GC content files (provided in [zenodo.org](https://zenodo.org/api/files/74b12cd4-d04c-4b86-a6ec-49da7a402888/GC.zip) for hg19)
* Mappability files (provided in [zenodo.org](https://zenodo.org/api/files/74b12cd4-d04c-4b86-a6ec-49da7a402888/mappability.zip) for hg19, or could be generated by [GEM library tools](https://wiki.bits.vib.be/index.php/Create_a_mappability_track)
