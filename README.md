...
* Dark regions (provided in resource folder for hg19, or could be downloaded from UCSC table browser)
* GC content files (provided in [zenodo.org]() for hg19)
* Mappability files (provided in [zenodo.org]() for hg19, or could be generated by [GEM library tools](https://wiki.bits.vib.be/index.php/Create_a_mappability_track)
